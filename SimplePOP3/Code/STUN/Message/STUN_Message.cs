        ...
        private void ParseAttribute(byte[] data,ref int offset)
        {
            ...
            */
            ...
            // USERNAME
                ...
                m_UserName = Encoding2.Default.GetString(data,offset,length);
                offset += length;
            }
            // PASSWORD
            else if(type == AttributeType.Password){
                m_Password = Encoding2.Default.GetString(data,offset,length);
                offset += length;
            }
            // MESSAGE-INTEGRITY
            ...
            // ERROR-CODE
                ...
                */
                ...
                m_pErrorCode = new STUN_t_ErrorCode(errorCode,Encoding2.Default.GetString(data,offset + 4,length - 4));
                offset += length;
            }
            // UNKNOWN-ATTRIBUTES
            ...
            // ServerName
                ...
                m_ServerName = Encoding2.Default.GetString(data,offset,length);
                offset += length;
            }
            // Unknown
            else{
