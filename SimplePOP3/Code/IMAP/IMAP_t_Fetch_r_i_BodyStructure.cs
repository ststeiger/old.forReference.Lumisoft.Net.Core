    ...
    public class IMAP_t_Fetch_r_i_BodyStructure : IMAP_t_Fetch_r_i
    {
        ...
        public IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart[] GetAttachments(bool includeInline)
        {
            ...
            foreach (IMAP_t_Fetch_r_i_BodyStructure_e entity in this.AllEntities)
            {
                ...
                {
                    if (disposition != null && String2.Equals(disposition.DispositionType, "attachment", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    }
                    else if (disposition != null && String2.Equals(disposition.DispositionType, "inline", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        if (includeInline)
                        {
                            retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    ...
                    else if (contentType != null && String2.Equals(contentType.Type, "application", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    }
                    else if (contentType != null && String2.Equals(contentType.Type, "image", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    }
                    else if (contentType != null && String2.Equals(contentType.Type, "video", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    }
                    else if (contentType != null && String2.Equals(contentType.Type, "audio", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    }
                    else if (contentType != null && String2.Equals(contentType.Type, "message", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        retVal.Add((IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)entity);
                    }
                }
        ...
        public bool IsSigned
        {
            get
            {
                foreach (IMAP_t_Fetch_r_i_BodyStructure_e entity in this.AllEntities)
                {
                    if (String2.Equals(entity.ContentType.TypeWithSubtype, MIME_MediaTypes.Application.pkcs7_mime, StringComparison2.InvariantCultureIgnoreCase))
                    {
                        return true;
                    }
                    else if (String2.Equals(entity.ContentType.TypeWithSubtype, MIME_MediaTypes.Multipart.signed, StringComparison2.InvariantCultureIgnoreCase))
                    {
                        return true;
                    }
                }
        ...
        public IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart BodyTextEntity
        {
            get
            {
                ...
                {
                    if (String2.Equals(e.ContentType.TypeWithSubtype, MIME_MediaTypes.Text.plain, StringComparison2.InvariantCultureIgnoreCase))
                    {
        ...
        public IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart BodyTextHtmlEntity
        {
            get
            {
                foreach (IMAP_t_Fetch_r_i_BodyStructure_e e in this.AllEntities)
                {
                    if (String2.Equals(e.ContentType.TypeWithSubtype, MIME_MediaTypes.Text.html, StringComparison2.InvariantCultureIgnoreCase))
                    {
                        return (IMAP_t_Fetch_r_i_BodyStructure_e_SinglePart)e;
                    }
                }
