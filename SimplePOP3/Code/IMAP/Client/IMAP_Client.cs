...
namespace LumiSoft.Net.IMAP.Client
{
    ...
    public class IMAP_Client : TCP_Client
    {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (responseLine.StartsWith("*"))
                        {
                            ...
                            if (String2.Equals(word, "OK", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "NO", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_ServerStatus.Parse(responseLine);

                                m_pImapClient.OnUntaggedStatusResponse((IMAP_r_u)m_pResponse);
                            }
                            else if (String2.Equals(word, "BAD", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_ServerStatus.Parse(responseLine);

                                m_pImapClient.OnUntaggedStatusResponse((IMAP_r_u)m_pResponse);
                            }
                            else if (String2.Equals(word, "PREAUTH", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_ServerStatus.Parse(responseLine);

                                m_pImapClient.OnUntaggedStatusResponse((IMAP_r_u)m_pResponse);
                            }
                            else if (String2.Equals(word, "BYE", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_ServerStatus.Parse(responseLine);
                            ...
                            else if (String2.Equals(word, "CAPABILITY", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "LIST", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "LSUB", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "STATUS", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "SEARCH", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "FLAGS", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (Net_Utils.IsInteger(word) && String2.Equals(parts[2], "EXISTS", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (Net_Utils.IsInteger(word) && String2.Equals(parts[2], "RECENT", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (Net_Utils.IsInteger(word) && String2.Equals(parts[2], "EXPUNGE", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_Expunge.Parse(responseLine);
                                m_pImapClient.OnMessageExpunged((IMAP_r_u_Expunge)m_pResponse);
                            }
                            else if (Net_Utils.IsInteger(word) && String2.Equals(parts[2], "FETCH", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "ACL", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_Acl.Parse(responseLine);
                            }
                            else if (String2.Equals(word, "LISTRIGHTS", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_ListRights.Parse(responseLine);
                            }
                            else if (String2.Equals(word, "MYRIGHTS", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "QUOTA", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                m_pResponse = IMAP_r_u_Quota.Parse(responseLine);
                            }
                            else if (String2.Equals(word, "QUOTAROOT", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "NAMESPACE", StringComparison2.InvariantCultureIgnoreCase))
                            {
                            ...
                            else if (String2.Equals(word, "ENABLED", StringComparison2.InvariantCultureIgnoreCase))
                            {
            ...
            while (true)
            {
                ...
                if (responseLine.StartsWith("*"))
                {
                    ...
                    if (String2.Equals(word, "OK", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        ...
                        {
                            if (String2.Equals(response.OptionalResponseCode, "PERMANENTFLAGS", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                if (folderInfo != null)
                                {
                            ...
                            else if (String2.Equals(response.OptionalResponseCode, "READ-ONLY", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                if (folderInfo != null)
                                {
                            ...
                            else if (String2.Equals(response.OptionalResponseCode, "READ-WRITE", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                if (folderInfo != null)
                                {
                                    folderInfo.SetReadOnly(true);
                            ...
                            else if (String2.Equals(response.OptionalResponseCode, "UIDNEXT", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                if (folderInfo != null)
                                {
                            ...
                            else if (String2.Equals(response.OptionalResponseCode, "UIDVALIDITY", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                if (folderInfo != null)
                                {
                            ...
                            else if (String2.Equals(response.OptionalResponseCode, "UNSEEN", StringComparison2.InvariantCultureIgnoreCase))
                            {
                                if (folderInfo != null)
                                {
        ...
        public int[] Search(bool uid, string charset, string criteria)
        {
            ...
            if (!String2.Equals(response.ResponseCode, "OK", StringComparison2.InvariantCultureIgnoreCase))
            {
