    ...
    public class IMAP_Session : TCP_ServerSession
    {
        ...
        protected override void Start()
        {
            ...
            */
            ...
            try
            {
                ...
                if (e.Response == null || String2.Equals(e.Response.ResponseCode, "NO", StringComparison2.InvariantCultureIgnoreCase))
                {
        ...
        private bool ProcessCmd(SmartStream.ReadLineAsyncOP op)
        {
            ...
            try
            {
                ...
                if (_CmdReader.EndsWithLiteralString(args) && !String2.Equals(cmd, "APPEND", StringComparison2.InvariantCultureIgnoreCase))
                {
            ...
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < statusItems.Length; i++)
                    {
                        ...
                        if (String2.Equals(statusItem, "MESSAGES", StringComparison2.InvariantCultureIgnoreCase))
                        {
                            msgCount = eMessagesInfo.Exists;
                        }
                        else if (String2.Equals(statusItem, "RECENT", StringComparison2.InvariantCultureIgnoreCase))
                        {
                            recentCount = eMessagesInfo.Recent;
                        }
                        else if (String2.Equals(statusItem, "UIDNEXT", StringComparison2.InvariantCultureIgnoreCase))
                        {
                            uidNext = eMessagesInfo.UidNext;
                        }
                        else if (String2.Equals(statusItem, "UIDVALIDITY", StringComparison2.InvariantCultureIgnoreCase))
                        {
                            folderUid = eSelect.FolderUID;
                        }
                        else if (String2.Equals(statusItem, "UNSEEN", StringComparison2.InvariantCultureIgnoreCase))
                        {
        ...
        private void SELECT(string cmdTag, string cmdText)
        {
            ...
            */
            ...
            if (args.Length >= 2)
            {
                ...
                if (String2.Equals(args[1], "(UTF8)", StringComparison2.InvariantCultureIgnoreCase))
                {
        ...
        private void ENABLE(string cmdTag, string cmdText)
        {
            ...
            */
            ...
            {
                if (String2.Equals("UTF8=ACCEPT", capa, StringComparison2.InvariantCultureIgnoreCase))
                {
                    ...
                    else
                    {
                        ...
                        while (remainingSection.Length > 0)
                        {
                            ...
                            if (!Net_Utils.IsInteger(section_parts[0]))
                            {
                                ...
                                if (String2.Equals(remainingSection, "HEADER", StringComparison2.InvariantCultureIgnoreCase))
                                {
                                ...
                                else if (String2.Equals(remainingSection, "HEADER.FIELDS", StringComparison2.InvariantCultureIgnoreCase))
                                {
                                ...
                                else if (String2.Equals(remainingSection, "HEADER.FIELDS.NOT", StringComparison2.InvariantCultureIgnoreCase))
                                {
                                    rSection.ReadToFirstChar();
                                    if (!rSection.StartsWith("("))
                                    {
                                ...
                                else if (String2.Equals(remainingSection, "MIME", StringComparison2.InvariantCultureIgnoreCase))
                                {
                                    fetchDataType = IMAP_Fetch_DataType.FullMessage;
                                }
                                else if (String2.Equals(remainingSection, "TEXT", StringComparison2.InvariantCultureIgnoreCase))
                                {
                                    fetchDataType = IMAP_Fetch_DataType.FullMessage;
                                }
                        ...
                        using (MemoryStreamEx tmpFs = new MemoryStreamEx(32000))
                        {
                            ...
                            else
                            {
                                ...
                                if (entity != null)
                                {
                                    ...
                                    if (String2.Equals(partSpecifier, "HEADER", StringComparison2.InvariantCultureIgnoreCase))
                                    {
                                    ...
                                    else if (String2.Equals(partSpecifier, "HEADER.FIELDS", StringComparison2.InvariantCultureIgnoreCase))
                                    {
                                    ...
                                    else if (String2.Equals(partSpecifier, "HEADER.FIELDS.NOT", StringComparison2.InvariantCultureIgnoreCase))
                                    {
                                        string fieldsString = section.Split(new char[] { ' ' }, 2)[1];
                                        string[] fieldNames = fieldsString.Substring(1, fieldsString.Length - 2).Split(' ');
                                        foreach (MIME_h field in entity.Header)
                                        {
                                            ...
                                            {
                                                if (String2.Equals(field.Name, fieldName, StringComparison2.InvariantCultureIgnoreCase))
                                                {
                                                    contains = true;
                                                    break;
                                                }
                                    ...
                                    else if (String2.Equals(partSpecifier, "MIME", StringComparison2.InvariantCultureIgnoreCase))
                                    {
                                        entity.Header.ToStream(tmpFs, new MIME_Encoding_EncodedWord(MIME_EncodedWordEncoding.B, Encoding.UTF8), Encoding.UTF8);
                                        // All header fetches must include header terminator(CRLF).
                                        if (tmpFs.Length > 0)
                                    ...
                                    else if (String2.Equals(partSpecifier, "TEXT", StringComparison2.InvariantCultureIgnoreCase))
                                    {
        ...
        private void SEARCH(bool uid, string cmdTag, string cmdText)
        {
            ...
            */
            ...
            if (r.StartsWith("CHARSET", false))
            {
                ...
                if (!(String2.Equals(charset, "US-ASCII", StringComparison2.InvariantCultureIgnoreCase) || String2.Equals(charset, "UTF-8", StringComparison2.InvariantCultureIgnoreCase)))
                {
        ...
        private void STORE(bool uid, string cmdTag, string cmdText)
        {
            ...
            */
            ...
            bool silent = false;
            if (String2.Equals(parts[1], "FLAGS", StringComparison2.InvariantCultureIgnoreCase))
            {
                setType = IMAP_Flags_SetType.Replace;
            }
            else if (String2.Equals(parts[1], "FLAGS.SILENT", StringComparison2.InvariantCultureIgnoreCase))
            {
                setType = IMAP_Flags_SetType.Replace;
                silent = true;
            }
            else if (String2.Equals(parts[1], "+FLAGS", StringComparison2.InvariantCultureIgnoreCase))
            {
                setType = IMAP_Flags_SetType.Add;
            }
            else if (String2.Equals(parts[1], "+FLAGS.SILENT", StringComparison2.InvariantCultureIgnoreCase))
            ...
            foreach (IMAP_MessageInfo msgInfo in m_pSelectedFolder.Filter(uid, seqSet))
            {
                ...
                response = e.Response;
                if (!String2.Equals(e.Response.ResponseCode, "OK", StringComparison2.InvariantCultureIgnoreCase))
                {
                    break;
                }
        ...
        private void UID(string cmdTag, string cmdText)
        {
            ...
            */
            ...
            if (String2.Equals(cmd_cmtText[0], "COPY", StringComparison2.InvariantCultureIgnoreCase))
            {
                COPY(true, cmdTag, cmd_cmtText[1]);
            }
            else if (String2.Equals(cmd_cmtText[0], "FETCH", StringComparison2.InvariantCultureIgnoreCase))
            {
                FETCH(true, cmdTag, cmd_cmtText[1]);
            }
            else if (String2.Equals(cmd_cmtText[0], "STORE", StringComparison2.InvariantCultureIgnoreCase))
            {
                STORE(true, cmdTag, cmd_cmtText[1]);
            }
            else if (String2.Equals(cmd_cmtText[0], "SEARCH", StringComparison2.InvariantCultureIgnoreCase))
            {
            ...
            */
            ...
            readLineOP.Completed += new EventHandler<EventArgs<SmartStream.ReadLineAsyncOP>>(delegate (object sender, EventArgs<SmartStream.ReadLineAsyncOP> e)
            {
                try
                {
                    ...
                    if (String2.Equals(readLineOP.LineUtf8, "DONE", StringComparison2.InvariantCultureIgnoreCase))
                    {
                        timer.Dispose();
        ...
        private bool SupportsCap(string capability)
        {
            foreach (string c in m_pCapabilities)
            {
                if (String2.Equals(c, capability, StringComparison2.InvariantCultureIgnoreCase))
                {
                    return true;
                }
            }
