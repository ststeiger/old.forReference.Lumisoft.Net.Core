...
namespace LumiSoft.Net.IMAP
{
    ...
    public class IMAP_r_ServerStatus : IMAP_r
    {
        ...
        public bool IsError
        {
            get
            {
                if(String2.Equals(m_ResponseCode, "NO", StringComparison2.InvariantCultureIgnoreCase))
                {
                    return true;
                }
                else if (String2.Equals(m_ResponseCode, "BAD", StringComparison2.InvariantCultureIgnoreCase))
                {
                    return true;
                }
                else
        ...
        public bool IsContinue
        {
            get
            {
                return String2.Equals(m_ResponseCode, "+", StringComparison2.InvariantCultureIgnoreCase);
            }
        }
