...
namespace LumiSoft.Net.IMAP
{
    ...
    public class IMAP_BODY_Entity
    {
        ...
        public int ContentSize
        {
            get
            {
                if (String2.Equals(this.ContentType.Type, "multipart", StringComparison2.InvariantCultureIgnoreCase))
                {
        ...
        public int ContentLines
        {
            get
            {
                if (!String2.Equals(this.ContentType.Type, "text", StringComparison2.InvariantCultureIgnoreCase))
                {
