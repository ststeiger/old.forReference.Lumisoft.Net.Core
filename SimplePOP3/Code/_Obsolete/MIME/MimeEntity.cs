...
namespace LumiSoft.Net.Mime
{
    ...
    public class MimeEntity
    {
        ...
        {
            // Write headers
            byte[] data = System.Text.Encoding2.Default.GetBytes(FoldHeader(this.HeaderString));
            ...
            if ((this.ContentType & MediaType_enum.Multipart) != 0)
            {
                ...
                foreach (MimeEntity entity in this.ChildEntities)
                {
                    ...
                    data = System.Text.Encoding2.Default.GetBytes("\r\n--" + boundary + "\r\n");
                    storeStream.Write(data, 0, data.Length);
        ...
        public string DataText
        {
            get
            {
                ...
                try
                {
                    ...
                    if (charSet == null)
                    {
                        return System.Text.Encoding2.Default.GetString(this.Data);
                    }
                    else
                    {
