...
namespace LumiSoft.Net.SMTP.Relay
{
    ...
    public class Relay_Session : TCP_Session
    {
        ...
        private bool IsDsnSupported()
        {
            ...
            {
                if (String2.Equals(feature, SMTP_ServiceExtensions.DSN, StringComparison2.InvariantCultureIgnoreCase))
                {
                    return true;
                }
            }
        ...
        private bool IsTlsSupported()
        {
            foreach (string feature in m_pSmtpClient.EsmtpFeatures)
            {
                if (String2.Equals(feature, SMTP_ServiceExtensions.STARTTLS, StringComparison2.InvariantCultureIgnoreCase))
                {
                    return true;
                }
            }
