        ...
        public string[] SaslAuthMethods
        {
            get
            {
                ...
                foreach (string feature in this.EsmtpFeatures)
                {
                    ...
                    if (String2.Equals(featureName, SMTP_ServiceExtensions.AUTH, StringComparison2.InvariantCultureIgnoreCase))
                    {
        ...
        public void Authenticate(string userName, string password)
        {
            ...
            else if (authMethod == "DIGEST-MD5")
            {
                ...
                */
                ...
                AUTH_SASL_DigestMD5_Challenge challenge = AUTH_SASL_DigestMD5_Challenge.Parse(Encoding2.Default.GetString(Convert.FromBase64String(line.Split(' ')[1])));
                ...
                // Send authentication info to server.
                WriteLine(Convert.ToBase64String(Encoding2.Default.GetBytes(response.ToResponse())));
                ...
                // Check rspauth value.
                if (!String2.Equals(Encoding2.Default.GetString(Convert.FromBase64String(line.Split(' ')[1])), response.ToRspauthResponse(userName, password), StringComparison2.InvariantCultureIgnoreCase))
                {
