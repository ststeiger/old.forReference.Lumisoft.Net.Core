...
namespace LumiSoft.Net.MIME
{
    ...
    public abstract class MIME_b
    {
        ...
        internal virtual void SetParent(MIME_Entity entity, bool setContentType)
        {
            ...
            if (setContentType && (entity.ContentType == null || !String2.Equals(entity.ContentType.TypeWithSubtype, this.MediaType, StringComparison2.InvariantCultureIgnoreCase)))
            {
