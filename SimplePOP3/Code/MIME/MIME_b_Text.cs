    ...
    public class MIME_b_Text : MIME_b_SinglepartBase
    {
        ...
        public Encoding GetCharset()
        {
            ...
            else
            {
                ...
                else if (String2.Equals(this.Entity.ContentType.Param_Charset, "cp1252", StringComparison2.InvariantCultureIgnoreCase))
                {
                    return Encoding.GetEncoding("windows-1252");
                }
                // utf8 is invalid(must be utf-8), consider it as utf-8.
                else if (String2.Equals(this.Entity.ContentType.Param_Charset, "utf8", StringComparison2.InvariantCultureIgnoreCase))
                {
                    return Encoding.GetEncoding("utf-8");
                }
                // iso8859_1 is invalid(must be iso8859-1), consider it as iso8859_1.
                else if (String2.Equals(this.Entity.ContentType.Param_Charset, "iso8859_1", StringComparison2.InvariantCultureIgnoreCase))
                {
