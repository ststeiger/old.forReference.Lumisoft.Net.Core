            ...
            private void CapaReadResponseCompleted(SmartStream.ReadLineAsyncOP op)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if(String2.Equals(op.LineUtf8.Split(new char[] { ' ' }, 2)[0], "+OK", StringComparison2.InvariantCultureIgnoreCase))
                        {
                            // Read capa-list.
            ...
            private void ReadMultiLineResponseLineCompleted(SmartStream.ReadLineAsyncOP op)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        else if (String2.Equals(op.LineUtf8, ".", StringComparison2.InvariantCultureIgnoreCase))
                        {
        ...
        private void ReadServerGreetingCompleted(SmartStream.ReadLineAsyncOP op, CompleteConnectCallback connectCallback)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if(String2.StartsWith(op.LineUtf8, "+OK", StringComparison2.InvariantCultureIgnoreCase))
                    {
