...
namespace LumiSoft.Net
{
    ...
    public class StringReader
    {
        ...
        public bool EndsWith(string value, bool case_sensitive)
        {
            if (case_sensitive)
            {
                return String2.EndsWith(m_SourceString, value, StringComparison2.InvariantCulture);
            }
            else
            {
                return String2.EndsWith(m_SourceString, value, StringComparison2.InvariantCultureIgnoreCase);
            }
        }
