    ...
    public class SDP_MediaDescription
    {
        ...
        public void SetStreamMode(string streamMode)
        {
            ...
            for (int i = 0; i < m_pAttributes.Count; i++)
            {
                ...
                if (String2.Equals(sdpAttribute.Name, "sendrecv", StringComparison2.InvariantCultureIgnoreCase))
                {
                    m_pAttributes.RemoveAt(i);
                    i--;
                }
                else if (String2.Equals(sdpAttribute.Name, "sendonly", StringComparison2.InvariantCultureIgnoreCase))
                {
                    m_pAttributes.RemoveAt(i);
                    i--;
                }
                else if (String2.Equals(sdpAttribute.Name, "recvonly", StringComparison2.InvariantCultureIgnoreCase))
                {
                    m_pAttributes.RemoveAt(i);
                    i--;
                }
                else if (String2.Equals(sdpAttribute.Name, "inactive", StringComparison2.InvariantCultureIgnoreCase))
                {
                    m_pAttributes.RemoveAt(i);
                    i--;
                }
