            ...
            */
            ...
            get
            {
                ...
                if (encoding != null)
                {
                    ...
                    {
                        data = System.Text.Encoding2.Default.GetString(MIME_Utils.QuotedPrintableDecode(System.Text.Encoding2.Default.GetBytes(data)));
                    }
                    else if (encoding == "b" || encoding == "base64")
                    {
                        data = System.Text.Encoding2.Default.GetString(Net_Utils.FromBase64(System.Text.Encoding2.Default.GetBytes(data)));
                    }
                    else
                    {
                ...
                if (charset != null)
                {
                    data = System.Text.Encoding.GetEncoding(charset).GetString(System.Text.Encoding2.Default.GetBytes(data));
                }
